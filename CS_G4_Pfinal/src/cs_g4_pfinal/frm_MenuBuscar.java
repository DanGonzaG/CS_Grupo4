...
import cs_g4_pfinal.frm_SubmenuBuscar_Categoria;
import cs_g4_pfinal.frm_SubmenuBuscar_IdProducto;
import cs_g4_pfinal.frm_SubmenuBuscar_Marca;
...
public class frm_MenuBuscar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frm_MenuBuscar
     */
    public frm_MenuBuscar() {
        initComponents();
    ...
    private void Volver_MenuPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Volver_MenuPrincipalActionPerformed
        // TODO add your handling code here:
        frm_MenuPrincipal pri = new frm_MenuPrincipal();
    ...
    private void Buscar_CategoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buscar_CategoriaActionPerformed
        // TODO add your handling code here:
        frm_SubmenuBuscar_Categoria BusC = new frm_SubmenuBuscar_Categoria();
        this.setVisible(false);
    ...
    private void Buscar_MarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buscar_MarcaActionPerformed
        // TODO add your handling code here:
        frm_SubmenuBuscar_Marca BusM = new frm_SubmenuBuscar_Marca();
        this.setVisible(false);
    ...
    private void Buscar_IdProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Buscar_IdProductoActionPerformed
        // TODO add your handling code here:
        frm_SubmenuBuscar_IdProducto BusIdP = new frm_SubmenuBuscar_IdProducto();
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_MenuBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_MenuBuscar().setVisible(true);
            }
        });
    }
